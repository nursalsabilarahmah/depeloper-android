package poliban.ac.id.salsabila.navdrawerexperiment;
...
import poliban.ac.id.e020320041.navdrawerexperiment.R;
        ...
        if (fab != null) {
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Snackbar.make(view, "Reflace with your own action", Snackbar.LENGTH_LONG)
